...
var file_greetpb_greet_proto_rawDesc = []byte{
	...
	0x32, 0x0a, 0x18, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x44, 0x65, 0x61, 0x6c,
	...
	0x75, 0x6c, 0x74, 0x32, 0x86, 0x03, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72,
	...
	0x01, 0x30, 0x01, 0x12, 0x57, 0x0a, 0x11, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68,
	...
	0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x67, 0x72, 0x65, 0x65,
	0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x44, 0x65, 0x61, 0x6c, 0x69,
	0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07,
...
var file_greetpb_greet_proto_depIdxs = []int32{
	...
	10, // 14: greet.GreetService.GreetWithDeadline:output_type -> greet.GreetWithDealineResponse
...
type GreetServiceClient interface {
	// Unary
	//convetion of rpc (remote procedure call): something (somethingRequest) returns (somethingResponse)
	...
	// Deadline
	GreetWithDeadline(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWithDealineResponse, error)
}
...
func (c *greetServiceClient) GreetWithDeadline(ctx context.Context, in *GreetWithDeadlineRequest, opts ...grpc.CallOption) (*GreetWithDealineResponse, error) {
...
type GreetServiceServer interface {
	...
	// Deadline
	GreetWithDeadline(context.Context, *GreetWithDeadlineRequest) (*GreetWithDealineResponse, error)
}
...
func (*UnimplementedGreetServiceServer) GreetWithDeadline(context.Context, *GreetWithDeadlineRequest) (*GreetWithDealineResponse, error) {
